...
https://furry-pizza-7fa.notion.site/TECH-07-Final-Project-Submission-Advanced-Data-Science-Agentic-AI-Prototype-for-Global-Food-Sup-1f9111afefc18059b3eceb3d167a0b3a
...
- Deployed the final search engine via a **Gradio-based interface**, enabling real-time, responsive, and context-aware query results for users—particularly within the travel and food domains.

### **II. Deployment of Agentic AI for Proactive Weather & Agricultural Risk Alerts**

- Transforming Data Science into Practical Impact — Leveraged AI-based weather forecasting to build an automated email alert system, enabling timely notifications for climate risks and supporting proactive decision-making in agricultural management.
...
- By bridging **AI, meteorological data**, and global food supply analytics, the system enhances resilience and readiness across the agricultural ecosystem—especially in response to **climate volatility and structural fragilities** in food production.
...
- Deployed a **Mini Agentic AI System** that proactively delivers automated weather alerts via email to key stakeholders in food security organizations—providing early warnings on drought or extreme rainfall conditions, reducing uncertainty, and enhancing decision-making to safeguard global food systems and human well-being.
...
- **Quantitative data** supports strong storytelling at scale, but **LLM-based analysis** (e.g., from **TripAdvisor reviews** or **X/Twitter feeds**) unlocks deeper consumer and sentiment insights—proving highly effective for unstructured data.
...
- **RAG with API Integration (Model B)** achieved **zero hallucination and high precision** in semantic search—vastly outperforming traditional plain search (Model A). This underlines the importance of **Responsible AI** in preventing misinformation and promoting reliability.
...
### 🔗 **Integrating AI: Conceptual Mind Map & Workflow Framework**
...
Deployed a complete suite of models—OLS, Machine Learning (XGBoost, Random Forest), Neural Networks (ANN, CNN, RNN), and Deep Learning (LSTM)—to predict agricultural output by country. Integrated classification models and concluded with performance metrics and scenario simulations.
...
Enhanced workflow scalability by integrating cutting-edge AI search techniques—embedding, chunking, OpenAI APIs—and executed A/B testing to benchmark plain search vs. RAG-enhanced semantic search.
...
```jsx
i. Integrated Weather Forecasting APIs to automate and streamline predictions of weather conditions—classifying them into heavy rain, sunny, flood, or drought—with a special focus on major food-producing countries.
...
Promt <> “Global food supply chains will …”
...
- ✅ **Constrain AI Responses to Verified Sources**: Ensure all AI-generated outputs—especially in semantic search—are grounded strictly in **retrieved embeddings or chunked content**, not external hallucinations or speculative answers.
- 🔐 **Prompt Design for Data Privacy Compliance**: Implement **clear and constrained prompts** in Agentic AI workflows to **avoid unintended outreach** (e.g., emails sent to unauthorized or unrelated recipients), especially when issuing alerts about sensitive topics like extreme weather or food shortages.
- 📍 **Context-Aware Filtering**: Integrate logic filters and IF-nodes to confirm recipient relevance and authority before executing automated communications—**preventing public misinformation or panic.**
...
✅ Traditional OLS and ML & DP Predictive Models for product amount by country and classification Prediction

✅ LLM Integration with X(Tweets) - PCA, Sentiment Analysis, Bigram NLP and GPT-2 NLP

✅ Search/RAG and API and AI

✅ Robust A/B testing (Plain Semantic vs. RAG Semantic Search)-Use case TripAdvisor Restaurant Reviews

✅ Executed mini Agentic AI for Data Science in Weather Forecasting and Food Supply Sustainability
